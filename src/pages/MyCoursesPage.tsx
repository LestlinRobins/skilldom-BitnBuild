    ...
    <div className="min-h-screen bg-primary-700 text-white">
      ...
      <div className="bg-gradient-to-r from-primary-800 to-primary-600 p-6 rounded-b-3xl">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-primary-700/50 rounded-xl p-4 text-center">
            <GraduationCap className="text-success-400 mx-auto mb-2" size={24} />
          ...
          <div className="bg-primary-700/50 rounded-xl p-4 text-center">
            ...
            <p className="text-2xl font-bold">{user?.ongoingCourses.length || 0}</p>
            ...
            {userBadges.map((badge: any) => {
              ...
              return (
                <div key={badge.id} className="flex-shrink-0 bg-primary-700/50 rounded-lg p-3 text-center min-w-[80px]">
                  <IconComponent className="text-accent-400 mx-auto mb-1" size={20} />
          ...
          {activeTab === 'completed' && (
            <>
              {completedCourses.length > 0 ? (
                ...
                <div className="text-center py-12">
                  <GraduationCap className="text-gray-500 mx-auto mb-4" size={48} />

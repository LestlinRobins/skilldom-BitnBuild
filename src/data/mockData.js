export const users = [
  {
    ...
    rating: 4.8,
    reviews: [
      { id: '1', rating: 5, comment: 'Excellent teacher! Made complex concepts easy to understand.', reviewer: 'Sarah Johnson' },
      { id: '2', rating: 5, comment: 'Very patient and thorough. Highly recommended!', reviewer: 'Mike Davis' }
    ],
    skillCoins: 1250,
    ongoingCourses: ['1', '3'],
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: [
      { id: '3', rating: 5, comment: 'Amazing design insights! Transformed our app completely.', reviewer: 'Alex Chen' }
    ],
    skillCoins: 890,
    ongoingCourses: ['2', '4'],
...
export const courses = [
  {
    ...
    description: 'Master React hooks, context API, and state management patterns for scalable applications.',
    teacherId: '1',
  ...
  },
  {
    ...
    description: 'Learn design thinking, user research, and prototyping with industry-standard tools.',
    teacherId: '2',
  ...
  },
  {
    ...
    description: 'Comprehensive guide to modern digital marketing, SEO, and content strategy.',
    teacherId: '4',
  ...
  },
  {
    ...
    description: 'Build complete web applications from frontend to backend with modern JavaScript.',
    teacherId: '1',
    skillCategory: 'Web Development',
    svcValue: 300,
    duration: 240,
  ...
  },
  {
    ...
    description: 'Create stunning interactive visualizations and dashboards with D3.js.',
    teacherId: '3',
    skillCategory: 'Data Science',
    svcValue: 220,
    duration: 135,
...
export const projects = [
  {
    ...
    description: 'A mobile app to help users track their carbon footprint and find eco-friendly alternatives.',
  ...
  },
  {
    ...
    description: 'Machine learning system that recommends recipes based on dietary preferences and available ingredients.',
    requiredSkills: ['Machine Learning', 'Python', 'API Development'],
    members: ['1', '3'],
    status: 'open',
    gallery: [
  ...
  },
  {
    ...
    description: 'Community-driven platform to discover and promote local businesses with reviews and events.',
    requiredSkills: ['Web Development', 'Digital Marketing', 'Community Management'],
    members: ['2', '4'],
    status: 'completed',
    gallery: [
...
export const badges = [
  { id: '1', name: 'First Course', icon: 'Trophy', description: 'Completed your first course' },
  { id: '2', name: 'Streak Master', icon: 'Flame', description: '7-day learning streak' },
  { id: '3', name: 'Collaborator', icon: 'Users', description: 'Joined your first project' },
  { id: '4', name: 'Skill Sharer', icon: 'BookOpen', description: 'Taught your first course' },
  { id: '5', name: 'AI Verified', icon: 'Shield', description: 'Skills verified by AI' }
];